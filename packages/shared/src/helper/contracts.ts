...
import genKeyStakeABIJSON from './abis/GenesisNftStake.json'
import looksrareExchangeABIJSON from './abis/LooksrareExchange.json'
import looksrareProtocolABIJSON from './abis/LooksrareProtocol.json'
import marketplaceEventABIJSON from './abis/MarketplaceEvent.json'
import merkleAirdropABIJSON from './abis/MerkleDistributor.json'
import Multicall2ABIJSON from './abis/Multicall2.json'
import nftMarketplaceABIJSON from './abis/NftMarketplace.json'
import nftProfileABIJSON from './abis/NftProfile.json'
import nftResolverABIJSON from './abis/NftResolver.json'
import openseaSeaportABIJSON from './abis/OSSeaport.json'
import openseaSeaport1_4ABIJSON from './abis/OSSeaport1_4.json'
import profileAuctionABIJSON from './abis/ProfileAuction.json'
import validationLogicABIJSON from './abis/ValidationLogic.json'
import x2y2ABIJSON from './abis/X2Y2.json'
