...
export class createTxTables1657044241364 implements MigrationInterface {

  name = 'createTxTables1657044241364'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TYPE "public"."tx_bid_exchange_enum" AS ENUM(\'OpenSea\', \'LooksRare\')')
    await queryRunner.query('CREATE TABLE "tx_bid" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "exchange" "public"."tx_bid_exchange_enum" NOT NULL, "activityId" character varying NOT NULL, CONSTRAINT "REL_cb9e1eab46dcdac05289e029d9" UNIQUE ("activityId"), CONSTRAINT "PK_03d1588fe81da5ebac29924a68a" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('CREATE TABLE "tx_list" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "exchange" "public"."tx_list_exchange_enum" NOT NULL, "activityId" character varying NOT NULL, CONSTRAINT "REL_2672650ab1887ba1f93ff742d3" UNIQUE ("activityId"), CONSTRAINT "PK_626af936cae7ce4d0445afd6839" PRIMARY KEY ("id"))')
