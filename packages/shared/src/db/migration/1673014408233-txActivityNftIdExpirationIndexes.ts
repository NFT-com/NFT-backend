...
export class txActivityNftIdExpirationIndexes1673014408233 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE INDEX CONCURRENTLY "IDX_30515d2ad413e74246306659d3" ON "tx_activity" ("expiration") ')
    await queryRunner.query('CREATE INDEX CONCURRENTLY idx_tx_activity_nftid ON "tx_activity" USING GIN ("nftId") ')
  }
