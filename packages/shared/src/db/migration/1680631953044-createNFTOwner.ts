...
export class createNFTOwner1680631953044 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "nft_owner" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "balance" integer NOT NULL DEFAULT 1, "nftId" character varying, "walletId" character varying, CONSTRAINT "PK_83cfd3a290ed70c660f8c9dfe2c" PRIMARY KEY ("id"))`);
