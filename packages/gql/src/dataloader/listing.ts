...
export const listingsByNFTExpiredAndCancelled =
new DataLoader<entity.NFT & { args: any }, Pageable<entity.TxActivity>, string>(
  async (keys) => {
    const listings = await repositories.txActivity
      .findActivitiesForNFTs(
        [...keys],
...
export const listingsByNFTExpiredAndExecuted =
new DataLoader<entity.NFT & { args: any }, Pageable<entity.TxActivity>, string>(
  async (keys) => {
    const listings = await repositories.txActivity
      .findActivitiesForNFTs(
