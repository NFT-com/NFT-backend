...
export class createTxTablesModified1659640532371 implements MigrationInterface {

  name = 'createTxTablesModified1659640532371'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "tx_order" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "exchange" "public"."tx_order_exchange_enum" NOT NULL, "orderHash" character varying NOT NULL, "makerAddress" character varying NOT NULL, "takerAddress" character varying, "orderType" "public"."tx_order_ordertype_enum" NOT NULL, "protocol" "public"."tx_order_protocol_enum" NOT NULL, "protocolData" json NOT NULL, "chainId" character varying, "activityId" character varying NOT NULL, CONSTRAINT "UQ_ab7ebf4e776541aadf20eacad69" UNIQUE ("orderHash"), CONSTRAINT "REL_7b92bab8a75d0b8d9056826d00" UNIQUE ("activityId"), CONSTRAINT "PK_a3a5d513d804ee2aea8d3642ef3" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('CREATE TABLE "tx_activity" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "activityType" "public"."tx_activity_activitytype_enum" NOT NULL, "activityTypeId" character varying, "read" boolean NOT NULL DEFAULT false, "timestamp" TIMESTAMP NOT NULL, "walletId" character varying NOT NULL, "chainId" character varying, CONSTRAINT "PK_6e367e6e0098602877808f4e516" PRIMARY KEY ("id"))')
