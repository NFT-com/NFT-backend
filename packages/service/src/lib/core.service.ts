...
export const getWallet = (ctx: Context, input: WalletInput): Promise<entity.Wallet> => {
 ...
 * @param {pagination.PageInput} pageInput - The page input object.
...
export const paginatedResultFromIndexedArray = (array: Array<any>, pageInput: pagination.PageInput): Pageable<any> => {
