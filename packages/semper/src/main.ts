...
const main = async (): Promise<void> => {
  ...
  // await commander.reindexNFTsByContract('0x98ca78e89Dd1aBE48A53dEe5799F24cC1A462F2D', await commander.retrieveListings({ nftContract: '0x98ca78e89Dd1aBE48A53dEe5799F24cC1A462F2D' }))
