...
export function nftTokenAddress(chainId: string | number = 'mainnet'): string {
  ...
  case '4':
  case 'rinkeby':
    return utils.getAddress('0x6b683aE60483124EDCAd68351Cdb90c697d5Fd9E')
  case '0':
  case 0:
  case 'mainnet':
  default:
...
export function genesisKeyTeamMerkleAddress(chainId: string | number = 'mainnet'): string {
  ...
  case 'rinkeby':
  case 4:
    return utils.getAddress('0x03D3A743997c02195A376cB9a6c23459611e8Cb6')
  case '0':
  case 0:
  case 'mainnet':
...
export function genesisKeyTeamClaimAddress(chainId: string | number = 'mainnet'): string {
  ...
  case 'rinkeby':
  case 4:
    return utils.getAddress('0x6aca5606f9418fe663465390BFda47ce3a1aFEC5')
  case '0':
  case 0:
  case 'mainnet':
...
export function genesisKeyAddress(chainId: string | number = 'mainnet'): string {
  ...
  case 'rinkeby':
  case 4:
    return utils.getAddress('0x5a889cfed56101A994Ef01b98318EB6e47328703')
  case '0':
  case 0:
  case 'mainnet':
...
export function genesisKeyStakeAddress(chainId: string | number = 'mainnet'): string {
  ...
  case 'rinkeby':
  case 4:
    return utils.getAddress('0x8AD706E4596CAd2458929E6a29270DFc107d5e8b')
  case '0':
  case 0:
  case 'mainnet':
...
export function nftProfileAddress(chainId: string | number = 'mainnet'): string {
  ...
  case '4':
  case 'rinkeby':
    return utils.getAddress('0x483d9729c15bd7A4e749F20066235f0D6974eA78')
  case '0':
  case 0:
  case 'mainnet':
  default:
...
export function profileAuctionAddress(chainId: string | number = 'mainnet'): string {
  ...
  case 'rinkeby':
  case 4:
    return utils.getAddress('0xa7D4dEd902E081c5Cc14e9628252705614bE8906')
  case '0':
  case 0:
  case 'mainnet':
