...
export class UpdateEdgeTypeEnum1647465037671 implements MigrationInterface {

  name = 'UpdateEdgeTypeEnum1647465037671'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('DROP INDEX "public"."IDX_0782d1067dcf4c7496e49a8142"')
    await queryRunner.query('DROP INDEX "public"."IDX_6d05b97f6bd418e7349581ce79"')
    await queryRunner.query('CREATE TYPE "public"."edge_edgetype_enum_old" AS ENUM(\'Follows\', \'Referred\', \'Displays\', \'Includes\')')
