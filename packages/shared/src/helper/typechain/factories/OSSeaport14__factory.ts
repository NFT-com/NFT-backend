...
import type { OSSeaport14, OSSeaport14Interface } from "../OSSeaport14";
...
export class OSSeaport14__factory {
  static readonly abi = _abi;
  static createInterface(): OSSeaport14Interface {
    return new utils.Interface(_abi) as OSSeaport14Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OSSeaport14 {
    return new Contract(address, _abi, signerOrProvider) as OSSeaport14;
  }
}
