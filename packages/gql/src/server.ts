      ...
      .then((profile: entity.Profile) => {
        if (!profile) {
          ...
          return res.send({
            ...
            image: profile.photoURL ?? 'https://nft-com.s3.us-east-2.amazonaws.com/default_user.svg',
            header: profile.bannerURL ?? 'https://nft-com.s3.us-east-2.amazonaws.com/nftcomheader.png',
