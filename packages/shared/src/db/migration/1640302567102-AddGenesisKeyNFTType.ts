...
export class AddGenesisKeyNFTType1640302567102 implements MigrationInterface {

  name = 'AddGenesisKeyNFTType1640302567102'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TYPE "public"."bid_nfttype_enum" RENAME TO "bid_nfttype_enum_old"')
    await queryRunner.query('CREATE TYPE "public"."bid_nfttype_enum" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\', \'GenesisKey\')')
    ...
    await queryRunner.query('CREATE TYPE "public"."nft_type_enum" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\', \'GenesisKey\')')
    ...
    await queryRunner.query('ALTER TYPE "public"."nft_raw_type_enum" RENAME TO "nft_raw_type_enum_old"')
    await queryRunner.query('CREATE TYPE "public"."nft_raw_type_enum" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\', \'GenesisKey\')')
    await queryRunner.query('ALTER TABLE "nft_raw" ALTER COLUMN "type" TYPE "public"."nft_raw_type_enum" USING "type"::"text"::"public"."nft_raw_type_enum"')
    await queryRunner.query('DROP TYPE "public"."nft_raw_type_enum_old"')
    await queryRunner.query('CREATE INDEX "IDX_91fa6acf35b7416b33a5ed0b4a" ON "nft" ("type", "deletedAt", "createdAt", "profileId") ')
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP INDEX "public"."IDX_91fa6acf35b7416b33a5ed0b4a"')
    await queryRunner.query('CREATE TYPE "public"."nft_raw_type_enum_old" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\')')
    await queryRunner.query('ALTER TABLE "nft_raw" ALTER COLUMN "type" TYPE "public"."nft_raw_type_enum_old" USING "type"::"text"::"public"."nft_raw_type_enum_old"')
    await queryRunner.query('DROP TYPE "public"."nft_raw_type_enum"')
    await queryRunner.query('ALTER TYPE "public"."nft_raw_type_enum_old" RENAME TO "nft_raw_type_enum"')
    await queryRunner.query('CREATE TYPE "public"."nft_type_enum_old" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\')')
    ...
    await queryRunner.query('CREATE TYPE "public"."bid_nfttype_enum_old" AS ENUM(\'ERC721\', \'ERC1155\', \'Profile\')')
